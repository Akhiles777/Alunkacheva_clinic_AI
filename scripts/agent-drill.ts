...
const DIALOGS_WORKDAYS: Scenario[] = [
  ...
  {
    title: "В субботу спрашивают про БОС, а не про остеопатию",
    expect: "отвечает про того, кто ведёт БОС, а не про остеопатов",
    channel: "WHATSAPP",
    turns: ["Здравствуйте! А БОС-терапия в субботу есть?", "А в воскресенье?"],
  },
  {
