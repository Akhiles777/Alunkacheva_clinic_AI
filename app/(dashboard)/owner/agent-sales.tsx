 ...
 *
 * Продажей считается доведённая до администратора заявка НОВОГО пациента:
 * ассистент сам попросил данные, человек их прислал, и администратору осталось
 * поставить время. Запись, которую от начала до конца оформил администратор, и
 * запись постоянного пациента сюда не идут — иначе раздел приписывал бы себе
 * весь поток клиники и всегда выглядел бы успешным.
 *
    ...
    <section className="border-border bg-surface mt-4 rounded-xl border p-5">
      ...
      {report.bookings === 0 ? (
        <p className="text-text-muted mt-3 text-sm">
          ...
          он сам попросил данные, пациент их прислал — и этот пациент в клинике впервые.
        </p>
      ) : (
        <>
          <div className="mt-4 grid grid-cols-2 gap-3 md:grid-cols-3">
            <Figure
              ...
              hint="ассистент спросил данные, человек ответил, время поставил администратор"
            />
            <Figure
        ...
        >
          ...
          >
            <div className="flex items-baseline gap-3">
              <h3 className="text-sm font-medium">Новые пациенты, которых довёл ассистент</h3>
              <button
                type="button"
                onClick={() => setOpen(false)}
            ...
            <p className="text-text-subtle mt-1 text-2xs">
              Здесь видно, что именно засчитано: пациент, услуга и деньги. В счёт идут только те,
              кто в клинике впервые и кого ассистент довёл сам — спросил данные и получил ответ.
              Если строка выглядит чужой — значит уточнять надо правило, а не число.
            </p>
