...
export function NotificationsClient({ initial }: { initial: NotificationsSettings }) {
  const [form, setForm] = useState<NotificationsSettings>(() => structuredClone(initial));
        ...
        <SaveBar
          onSave={() => {
            startTransition(async () => {
              await saveSection("notifications", form);
            });
          }}
        />
