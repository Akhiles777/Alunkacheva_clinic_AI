    ...
    <div className="flex flex-col">
      ...
      */}
              ...
              <li key={visit.id} className="flex items-baseline gap-3">
                ...
                <span className="min-w-0 flex-1">
                  ...
                  {/*
                    ...
                    Мать записывает себя и ребёнка одной записью: в ней взрослый
                    приём 8 000 и детский 5 000. Мы показывали название первой
                    услуги и сумму обеих — «Взрослый приём — остеопатия,
                ...
                */}
                {visit.status !== "arrived" ? null : visit.amount > 0 ? (
                  ...
                  */
                  ...
                  /*
                    «Скидка 100%» — факт из записи, «бесплатно» — вывод из него.
                    Вывод бывает неверным: так закрывают и подарок, и визит,
                    входящий в стоимость основного приёма. Пишем факт.
                  */
                  <span
                    className="text-text-muted flex-none text-xs"
                    title="В записи YCLIENTS стоит скидка 100%. Так отмечают и подарок, и приём, входящий в стоимость основного, — денег этот визит не принёс."
                  >
                    скидка 100%
                  </span>
                ) : (
                  /*
                    Ноль без скидки и без курса — это НЕ «бесплатно».

                    Так выглядит запись, в которой стоимость не проставили.
                    Владелец справедливо возмутился: «как БОС-терапия может
                    быть бесплатно, как КОНТРОЛЬ может быть бесплатно» — по
                    отчёту КОНТРОЛЬ приносит 30 000 ₽. Мы не знаем, отдали приём
                    даром или забыли цену, и утверждать первое нельзя.
                  */
                  <span
      ...
      <div className="border-border-soft text-text-subtle mt-5 border-t pt-4 text-2xs">
        ...
        */}
        {/*
          «WhatsApp» и «WhatsApp · по первому обращению» — разные утверждения
          (§8). Первое сказал администратор, второе вывели мы: по самому раннему
          сообщению или занесённому звонку. Человек должен видеть, чей это
          ответ, прежде чем на него опереться. Про переписку тут не говорим —
          первым обращением бывает и звонок.
        */}
        Первое обращение: {firstContact} · источник: {patient.source ?? "из YCLIENTS"}
        {patient.sourceDerived && patient.source && patient.source !== "—"
