...
/**
 * Сколько напоминаний по одному ожиданию.
 *
 * Цель — не потерять пациента, а не завалить администратора одним и тем же.
 * После третьего диалог всё равно виден в инбоксе с меткой «нужен ответ», а
 * через сутки его заберёт агент.
 */
 ...
 * ответил, ожидание кончилось. Повторяем не чаще получаса и не больше трёх
 * раз — четвёртое напоминание об одном и том же перестают читать, а вместе с
 * ним перестают читать и новые.
 */
