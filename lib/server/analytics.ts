...
export async function getDashboardMetricsDb(
   ...
   */
  /**
   * «Из них курсами» — деньги за проданные курсы, а не сумма сеансов.
   *
   * Здесь складывалась выручка визитов, привязанных к курсу. Она нулевая по
   * определению: за сеанс курса клиника получила деньги при продаже, и в
   * записи дня стоит ноль. Поэтому на экране всегда стояло «курсами 0 ₽» —
   * число, которое не может стать другим, а выглядит как измеренное.
   *
   * Настоящие деньги курсов — их продажи; считаем их ниже, вместе с выручкой.
   */
