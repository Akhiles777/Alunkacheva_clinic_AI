...
export interface MoneySummary {
  ...
  /** Деньги ÷ оплаченные чеки: приёмы с суммой плюс проданные курсы (§8). */
  avgCheck: number;
  ...
  /**
   * Деньги за курсы, у которых специалист не определился.
   *
   * Они есть в выручке и в разрезе по услугам, но не могут попасть в разрез по
   * людям: услугу ведут двое, а сеансов у курса ещё не было. Показываем число
   * рядом с таблицей специалистов — иначе сумма её строк меньше итога, и
   * разница выглядит как пропавшие деньги.
   */
